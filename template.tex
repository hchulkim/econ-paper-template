...
\\Author 2\thanks{Another author's acknowledgements..}\\
University of WWW\\
...
\begin{table}[!h] 
  ...
  \input{tables.tex}}
  \begin{tablenotes}
      \item \footnotesize{\textit{Notes:} All values of export and import are from Comtrade dataset. All values are adjusted to year 2019 in billions USD. $\text{*}$ are stars}
    \end{tablenotes}
\end{table}
